...
class Chart {
  ...
  render(container) {
    ...
    const host = chatty.Chatty.createHost(chartUrl).withSandboxAttribute('allow-scripts').withSandboxAttribute('allow-same-origin').withSandboxAttribute('allow-popups').withSandboxAttribute('allow-popups-to-escape-sandbox').appendTo(embedRoot).on('refreshToken', () => this.retrieveAndSetToken()).build(); // Customise IFrame styles
